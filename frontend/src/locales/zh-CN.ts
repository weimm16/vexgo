...
export const zhCN = {
  ...
  creatorApplication: {
    applyButton: "申请成为创作者",
    reviewApplications: "审核创作者申请",
    title: "申请成为创作者",
    description: "申请成为创作者后，您将能够发布文章和参与更多社区活动。",
    currentRole: "当前角色",
    reasonLabel: "申请理由",
    reasonPlaceholder: "请简要说明您申请成为创作者的理由...",
    submit: "提交申请",
    submitting: "提交中...",
    confirmTitle: "确认申请",
    confirmDescription: "确定要提交创作者申请吗？管理员将在审核后通知您结果。",
    confirm: "确认申请",
    reviewTitle: "创作者申请审核",
    pendingApplications: "待审核申请",
    pendingCount: "待审核: {count} 个",
    noPendingApplications: "暂无待审核申请",
    noPendingApplicationsDesc: "所有创作者申请都已处理完成",
    appliedAt: "申请时间",
    approve: "通过",
    reject: "拒绝",
    approveConfirmTitle: "通过申请",
    approveConfirmDescription: "确定要通过用户 {username} 的创作者申请吗？",
    confirmApprove: "确认通过",
    rejectConfirmTitle: "拒绝申请",
    rejectConfirmDescription: "确定要拒绝用户 {username} 的创作者申请吗？",
    confirmReject: "确认拒绝",
    rejectReasonLabel: "拒绝理由",
    rejectReasonPlaceholder: "请输入拒绝此申请的理由...",
    status: {
      pending: "待审核",
      approved: "已通过",
      rejected: "已拒绝",
